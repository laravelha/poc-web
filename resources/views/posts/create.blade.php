        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h2>@lang('app.create.title', ['model' => __('posts.model')])</h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('posts.store') }}" method="post" name="create">
                        @csrf
...
@endpush
    ...
    @endif
                        ...
                        <div class="form-group">
                            ...
                            <button type="button" class="btn btn-outline-dark" onclick="location.href='{{ route('posts.index') }}'">@lang('app.cancel')</button>
                        </div>
                    </form>
                </div>
            </div>
